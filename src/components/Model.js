  ...
  return (
    ...
    <div>
        <div className='absolute inset-x-0 top-[15%] text-center'>
            ...
            <p className='p-2 text-sm'>Order Online for <a href="https://www.tesla.com/support/taking-delivery?redirect=no"><span className='underline underline-offset-4'>Touchless delivery</span></a> Touchless delivery</p>
        </div>
