        ...
        <div className='flex justify-between items-center px-12 p-4 text-sm font-bold'>
            ...
            <div className='hidden lg:inline'>
                <ul className='flex justify-center hover:cursor-pointer'>
                    <li className='py-1 px-3 hover:rounded hover:bg-black/5'><a href="https://tesla.com/models">Model S</a></li>
                    <li className='py-1 px-3 hover:rounded hover:bg-black/5'><a href="https://tesla.com/model3">Model 3</a></li>
                    <li className='py-1 px-3 hover:rounded hover:bg-black/5'><a href="https://tesla.com/modelx">Model X</a></li>
                    <li className='py-1 px-3 hover:rounded hover:bg-black/5'><a href="https://tesla.com/modely">Model Y</a></li>
                    <li className='py-1 px-3 hover:rounded hover:bg-black/5'><a href="https://tesla.com/solarroof">Solar</a> Roof</li>
                    <li className='py-1 px-3 hover:rounded hover:bg-black/5'><a href="https://tesla.com/solarpanels">Solar Panets</a></li>
            ...
            <div className={nav ? 'bg-white absolute top-0 right-0 w-80 h-full z-10' : "fixed right-[100%]"}>
                ...
                <ul className='pt-8 px-6'>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://tesla.com/models">Model S</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://tesla.com/model3">Model 3</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://tesla.com/modelx">Model X</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://tesla.com/modely">Model Y</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://tesla.com/solarroof">Solar Roof</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://tesla.com/solarpanels">Solar Panels</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://www.tesla.com/inventory/new/m3">Existing Inventory</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://www.tesla.com/inventory/used/m3">Used Inventory</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://www.tesla.com/tradein">Trade-in</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://www.tesla.com/drive">Test Drive</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
                        <a href="https://www.tesla.com/insurance">Insurance</a></li>
                    <li className='py-3 pl-3 hover:rounded hover:bg-black/5'>
